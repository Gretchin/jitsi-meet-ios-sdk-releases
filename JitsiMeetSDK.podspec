Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/Gretchin/jitsi-meet-ios-sdk-releases'
  s.license          = 'Apache 2'
  s.authors          = 'The Jitsi Meet project authors'
  s.source           = { :git => 'https://github.com/Gretchin/jitsi-meet-ios-sdk-releases.git', :tag => s.version }
